...
import logging
logger = logging.getLogger('jotty_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by JottyWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseJottyWindow object.
        """
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.jotty")
